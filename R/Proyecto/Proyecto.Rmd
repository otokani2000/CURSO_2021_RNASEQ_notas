...
1. if (interactive()) iSEE::iSEE(rse_gene) -> Graficas
2. ## Eliminamos genes
rse_gene_SRP132816 <- rse_gene_SRP132816[gene_means > 0.1, ]    -> SI es necesario eliminar ese 0.1 o no de genes.

3. Pongo el tissue o no??
...
Figura 3
Volvemos a visualizar una distribucion de los genes acorde a nuestros grupos(mayores y menores) en una grafiac tipo boxplot.
```{r}
library("ggplot2")
...
levels(col.tissue) <- brewer.pal(nlevels(col.tissue), "Set2")
